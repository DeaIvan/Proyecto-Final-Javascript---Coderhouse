document.addEventListener('DOMContentLoaded', () => {
    ...
    /*function cargarLocalStorage () {
        // Si existe un carrito en el local storage lo cargamos, sino declaramos el carrito vacio
        localStorage.getItem('carrito') !== null ? carrito = JSON.parse(localStorage.getItem('carrito')) : carrito = [];
        console.log("Tu carrito en localStorage", carrito);
    }*/
